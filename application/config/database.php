...
$db['default']['username'] = 'crowefsy_admin';
$db['default']['password'] = 'admin@admin';
$db['default']['database'] = 'crowefsy_asset_pie';
...
$db['default1']['username'] = 'root';
$db['default1']['password'] = 'root';
$db['default1']['database'] = 'db_abbott';
